package com.takeaway.demo.config;


import com.takeaway.demo.entity.Country;
...
public class MyDataRestConfig implements RepositoryRestConfigurer {
    ...
    public void configureRepositoryRestConfiguration(RepositoryRestConfiguration config) {
        ...
        // disable Http methods for Dish: PUT, POST and DELETE
        disableHttpMethods(Dish.class, config, theUnsupportedActions);

        // disable Http methods for DishCategory: PUT, POST and DELETE
        disableHttpMethods(DishCategory.class, config, theUnsupportedActions);

        // disable Http methods for Country: PUT, POST and DELETE
        disableHttpMethods(Country.class, config, theUnsupportedActions);

        // disable Http methods for County: PUT, POST and DELETE
